...
String q="select * from students where usn='"+a+"' and pass='"+b+"'";
...
out.println("<script>alert('Invalid Login! Check USN or Password');window.location.href='login.jsp';</script>");  
